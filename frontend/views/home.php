<div class="card card-primary card-outline">
  <div class="card-body box-profile">
    <a href="index.php?view=tribe" class="btn btn-block btn-lg btn-danger"><b>My Tribe</b></a>
    <?php
    // if ($day_now == 'Sunday') {
    ...
    // }
    echo '<a href="index.php?view=attendance" class="btn btn-block btn-lg btn-danger"><b>Sunday Celebration</b></a>';
    ?>
